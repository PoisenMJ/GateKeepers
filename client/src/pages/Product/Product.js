                ...
                <>
                    <div className="carousel slide" data-bs-ride="carousel" id="product-images">
                        <div className="carousel-inner" id="product-slides">
                            {product.images.map((image, index) => (
                                <div className={(index===0)?"carousel-item h-100 active":"carousel-item h-100"} key={index}>
                                    <img className="w-100 d-block product-image" src={`/images/products/${image}`} alt="Slide Image"/>
                                </div>
                            ))}
                        </div>
                        <div>
                        ...
                        <ol className="carousel-indicators">
                            <li data-bs-target="#product-images" data-bs-slide-to="0" className="active"></li>
