...
const CreatorsOrders = () => {
    ...
    return (
        <div id="admin-orders-parent">
            <input class="form-control-lg w-100 mb-2" type="text" placeholder="Search orders"/>
            <div class="accordion" role="tablist" id="accordion-1">
                {orders && orders.length > 0 ? orders.map((order, index) => {
                    ...
                    return (
                        <div class="accordion-item custom-black-accordion" key={index}>
                            <h2 class="accordion-header" role="tab">
                                <button class="accordion-button fw-bold" data-bs-toggle="collapse" 
                                            data-bs-target={"#accordion-1 .item-"+index} aria-expanded="true" 
                                            aria-controls={"accordion-1 .item-"+index}>{formattedDate} - £{order.total}
                                    <FaTimes className="fs-4 text-danger icon-3"/>
                                </button>
                            </h2>
                            <div class={"accordion-collapse collapse show item-"+index} role="tabpanel" data-bs-parent="#accordion-1">
