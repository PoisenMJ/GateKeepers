async function login(username, password) {
  const res = await fetch('/gatekeeper/login', {
    method: 'POST',
...
async function addOutfit(username, token, name, items, image) {
  ...
  const res = await fetch('/gatekeeper/outfit/create', {
    method: 'POST',
    body: formData,
  });
  const json = await res.json();
...
async function deleteOutfit(username, token, outfitID) {
  const res = await fetch('/gatekeeper/outfit/delete', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      username,
...
async function getOutfits(username) {
  const res = await fetch(`/gatekeeper/outfit/all/${username}`);
  const json = await res.json();
  return json;
}
...
async function addProduct(formData, username, token, order, images, customSize, sizes) {
  ...
  const res = await fetch('/gatekeeper/products/add', {
    method: 'POST',
    body: data,
  });
  const json = await res.json();
...
async function getOrders(username, token) {
  const res = await fetch('/gatekeeper/orders', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
async function removeProduct(productID, username, token) {
  const res = await fetch('/gatekeeper/products/remove', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
async function markOrderSent(orderID, username, token) {
  const res = await fetch('/gatekeeper/orders/mark-sent', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      username,
...
async function updateProduct(formData, username, token) {
  formData.append('token', token);
  formData.append('username', username);
  const res = await fetch('/gatekeeper/products/update', {
    method: 'POST',
    body: formData,
  });
  const json = await res.json();
...
async function getProduct(productID, username, token) {
  const res = await fetch(`/gatekeeper/products/${productID}`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
async function getProducts(username, token) {
  const res = await fetch(`/gatekeeper/products/all/${username}`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
async function getGatekeeper(username, token) {
  const res = await fetch(`/gatekeeper/${username}`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ token, username }),
  });
...
async function updateGatekeeper(data, username) {
  const res = await fetch(`/gatekeeper/update/${username}`, {
    method: 'POST',
    body: data,
  });
  const json = await res.json();
...
async function getGatekeeperCustomsMessages(username, token) {
  const res = await fetch('/gatekeeper/custom/all', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      username,
...
async function acceptGatekeeperCustom(username, token, user) {
  const res = await fetch('/gatekeeper/custom/accept', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      username,
...
async function declineGatekeeperCustom(username, token, user) {
  const res = await fetch('/gatekeeper/custom/decline', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      username,
...
async function sendCustomsMessage(username, token, message, to, type) {
  const res = await fetch('/gatekeeper/custom/send-message', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      username,
...
async function markReadCustomsChat(username, token, to) {
  const res = await fetch('/gatekeeper/custom/read', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      username,
...
async function hasCustomsOn(username) {
  const res = await fetch(`/gatekeeper/custom/check?username=${username}`);
  const json = await res.json();
  return json;
}
